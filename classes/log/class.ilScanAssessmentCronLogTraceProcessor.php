...
/**
 * Class ilScanAssessmentCronLogTraceProcessor
 */
class ilScanAssessmentCronLogTraceProcessor extends ilTraceProcessor
{
	...
	/**
	 * ilScanAssessmentCronLogTraceProcessor constructor.
	 * @param int @a_level
	 */
