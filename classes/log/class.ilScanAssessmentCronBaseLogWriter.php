...
ilScanAssessmentCronPlugin::getInstance()->includeClass('../interfaces/interface.ilScanAssessmentCronLogWriter.php');
/**
 * Class ilScanAssessmentBaseLogWriter
 */
abstract class ilScanAssessmentCronBaseLogWriter implements ilScanAssessmentCronLogWriter
{
