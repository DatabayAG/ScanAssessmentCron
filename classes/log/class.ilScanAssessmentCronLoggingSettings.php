...
/**
 * Class ilScanAssessmentCronLoggingSettings
 */
class ilScanAssessmentCronLoggingSettings implements ilLoggingSettings
{
	...
	public function getLogFile()
	{
		...
		return $this->now . 'ilScanAssessmentCron.log';
	}
