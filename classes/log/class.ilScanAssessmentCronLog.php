...
ilScanAssessmentCronPlugin::getInstance()->includeClass('../interfaces/interface.ilScanAssessmentCronLogger.php');
ilScanAssessmentCronPlugin::getInstance()->includeClass('log/class.ilScanAssessmentCronEchoWriter.php');
ilScanAssessmentCronPlugin::getInstance()->includeClass('log/class.ilScanAssessmentCronLogFileWriter.php');
/**
 * Class ilScanAssessmentLog
 */
class ilScanAssessmentCronLog implements ilScanAssessmentCronLogger
{
	/**
	 * @var self
	 */
	...
	{
		$this->addWriter(new ilScanAssessmentCronEchoWriter());
		$this->addWriter(new ilScanAssessmentCronLogFileWriter());
	}
	 ...
	 * @param int $priority
	 */
	public function addWriter(ilScanAssessmentCronBaseLogWriter $writer, $priority = 1)
	{
		$this->writer[] = $writer;
	}
	 ...
	 * @param ilScanAssessmentBaseLogWriter $writer
	 */
	public function removeWriter(ilScanAssessmentCronBaseLogWriter $writer)
	{
